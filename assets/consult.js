...
(() => {
  ...
  const SERVICES = [['hospital', '요양병원 입원·투석 상담'], ['nursing', '요양원 입소 상담'], ['homecare', '재가 서비스 상담']];
  ...
  dlg.innerHTML = `
    <form method="dialog" novalidate>
      ...
      <label>연락받을 분의 이름<input name="contact" autocomplete="name" maxlength="40" required></label>
      <label>전화번호<input name="phone" type="tel" inputmode="numeric" autocomplete="tel" placeholder="010-0000-0000" maxlength="20" required></label>
